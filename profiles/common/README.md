...
issue-intake, and workflow-validation files, and supplies the first `.gitignore`
fragment. It declares the required GitHub labels for live audit and declares
retired issue-form and pull-request-policy files absent. Dependabot
configuration is rendered from the manifest's structured dependency-update
declarations.
